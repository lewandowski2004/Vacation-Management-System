...
<div class="container">
    <a class="btn btn-success" href="${pageContext.request.contextPath}/admin/createEmployeesVacationBalanceExcel" role="button" style="float: right; margin: 15px">Exportuj do Excela</a>
    <hr>
    <div class="col-md-12">
        <div class="row">
            <div class="col-xs-12">
