            ...
            <div class="panel panel-login">
                <div class="panel-body">
                    <div class="row">
                        <div class="col-lg-12">
                            <br/>
                            <h3 style="text-align: center">Aktualizacja stanowiska</h3>
                            <hr>
                            <p style="color: red">${blad}</p>
                            <form:form id="register-form" modelAttribute="positionDto"
                                       action="/admin/update/position/${positionDto.id}" method="POST" role="form">
                                <div class="form-group">
                                    <label>Wybierz Dział</label>
                                    <%--<form:select id="inputState" class="form-control" path="nrDepartment">
                                        <form:option value="${positionDto.departmentDto.id}">${positionDto.departmentDto.name}</form:option>
                                        <form:option value="">-------------------</form:option>
                                        <form:options items="${departmentMap}"></form:options>
                                    </form:select>--%>
                                    <form:select path="nrDepartment" class="form-control">
                                       <%-- <form:option value="${positionDto.departmentDto.id}">${positionDto.departmentDto.name}</form:option>--%>
