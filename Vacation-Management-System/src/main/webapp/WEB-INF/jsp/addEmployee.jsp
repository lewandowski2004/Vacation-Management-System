                        ...
                        <div class="col-lg-12">
                            ...
                            <form:form modelAttribute="employeeWithVacationBalanceDto"
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-4">
                                        <form:input type="password" name="password" id="password" path="password"
                                                    tabindex="2" class="form-control" placeholder="Hasło"/>
                                        <form:errors path="password" cssClass="help-block" element="em"/>
                                    </div>
                                    <label class="col-lg-2 col-form-label"><p>powtórz</p></label>
                                    <div class="col-lg-4">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-10">
                                        <form:input type="text" name="addressLine1" id="addressLine1"
                                                    path="addressLine1"
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-10">
                                        <form:input type="text" name="addressLine2" id="addressLine2"
                                                    path="addressLine2"
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-10">
                                        <form:select id="departmentSelect" class="form-control" path="departmentDto">
                                            <form:option value="${department.id}">Wybierz dział</form:option>
                                            <form:options items="${departmentMap}"></form:options>
                                        </form:select>
                                        <form:errors path="departmentDto" cssClass="help-block" element="em"/>
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-10">
                                        <form:select id="positionSelect" class="form-control"
                                                     path="positionDto"></form:select>
